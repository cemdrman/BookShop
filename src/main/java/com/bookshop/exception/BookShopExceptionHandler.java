...
public class BookShopExceptionHandler {
	...
	public final <T> ResponseEntity<ServiceReponse<T>> handle(Exception ex, WebRequest request) {
		return ResponseBuilder.failure(ex.getMessage(), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(CustomerNotFoundException.class)
	public final <T> ResponseEntity<ServiceReponse<T>> handle(CustomerNotFoundException ex, WebRequest request) {
